...
use pyo3::types::{PyFrozenSet, PyList, PySet, PyString, PyTuple};
use valgebra_core::{
    ClassIx, CollKind, ConstIx, Constraint, DefIx, OperandIx, PathSegment, PredIx, Schema, SeqKind,
    SeqShape, Violation,
};

use crate::check::ctx::{Ctx, MAX_WALK_DEPTH, WalkMode};
use crate::check::index::compile_pattern;
use crate::check::violation::{mismatch, summarize_value, type_fail, type_mismatch};
