...
| [03-frontend.md](03-frontend.md) | `crates/valgebra-py/src/build.rs` and `build/` — typing annotations into the IR |
...
| [08-testing.md](08-testing.md) | the test layers, the three mutation sweeps, the thirty-eight ledgers, the completeness probe |
